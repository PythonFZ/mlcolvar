...
from mlcolvar.core import KAN, Normalization
...
class KANDeepTDA(BaseCV, lightning.LightningModule):
    """
...
def test_KAN_deeptda_cv():
    ...
    for states_and_cvs in [[2, 1], [3, 1], [3, 2], [5, 4]]:
        ...
        traced_model = model.to_torchscript(
            file_path=None, method="script", example_inputs=X[0]
        )
        # model.eval()
